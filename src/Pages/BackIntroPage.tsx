  ...
  return (
    <div>
      ...
      >
        ...
        />
        <div className={styles.mainBold}>Learn Create Elevate</div>
        <div className={styles.mainDefault}>강남대학교 멋쟁이사자처럼 백엔드 팀에서는 함께 배우고 성장하며, 끝까지 함께할 열정적인 분들을 찾고 있습니다!</div>
        ...
        >
          ...
          <div className={styles.textWrapper}>
            <p className={styles.sectionText}>
              백엔드 개발은 서비스의 핵심 기능을 설계하고 구현하며, 주로 서버와 데이터베이스를 관리해 책임지는 중요한 분야입니다. API 설계 및 구현을 통해 클라이언트와 서버 간 원활한 통신을 가능하게
              하고, 데이터베이스를 효율적으로 관리하여 대규모 데이터 처리와 저장을 안정적으로 지원합니다. 강남대학교 멋쟁이사자처럼 백엔드 파트에서는 Java, Spring Boot, 그리고 MariaDB와 같은 기술
              스택을 활용하여 안정적이고 확장 가능한 서비스를 개발합니다. 이러한 과정에서 사용자 요구사항에 맞춘 기능을 구현하고, 성능 최적화와 보안을 강화하며, 서비스 품질을 높이는 데 주력합니다.
